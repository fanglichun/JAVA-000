...
public class HttpOutboundHandler {
    ...
    private void handleResponse(final FullHttpRequest fullRequest, final ChannelHandlerContext ctx, final HttpResponse endpointResponse) throws Exception {
        ...
        try {
            ...
            String headerKey = requestHeaders.get("header_key");
            System.out.println("获取request的header信息:" + headerKey);
            response.headers().set("header_key", requestHeaders.get(headerKey));
        } catch (Exception e) {
            e.printStackTrace();
